...
% This code chunk is used to include global Knitr options 
<<global_knitr_options, child='subdocuments/global_knitr_options.Rnw', eval=TRUE>>=
@
...
<<subdoc_content_header, child='subdocuments/header.Rnw', eval=T>>=
@
...
<<subdoc_content_material_methods, child='subdocuments/material_methods.Rnw', eval=T>>=
@
...
<<subdoc_content_acknowledgement, child='subdocuments/acknowledgement.Rnw', eval=T>>=
@
...
<<options_bibliography, child='subdocuments/options_bibliography.Rnw', eval=T>>=
@
