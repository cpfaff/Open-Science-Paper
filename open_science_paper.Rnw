...
\documentclass[color, noprint, nocsvdata, nogitinfo]{subdocuments/open_science_paper} 

%% Available class options [defaults]
% - [color]/nocolor Changes between colorful output and a black and white theme 
% - [nocsvdata]/csvdata  With csv data enabled you can use the csv file under
%   the data folder to insert title header information into the document.
% - [nogitinfo]/gitinfo include git information into the title header of the 
...
% - [noprint]/print switches between the color model rgb which is optimal for displays 
