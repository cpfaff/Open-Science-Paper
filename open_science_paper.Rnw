...
\documentclass[nocolor, fontsize=11pt, headings=small, captions=tableheading, pagesize=auto, DIV=20, notitlepage, oneside, final]{subdocuments/open_science_paper}
