...
<<subdoc_content_abstract, child='subdocuments/osp_abstract.Rnw', eval=T>>=
@
...
<<subdoc_content_introduction, child='subdocuments/osp_introduction.Rnw', eval=T>>=
@
...
<<subdoc_content_material_methods, child='subdocuments/osp_material_methods.Rnw', eval=T>>=
@
...
<<subdoc_content_results, child='subdocuments/osp_results.Rnw', eval=T>>=
@
...
<<subdoc_content_discussion, child='subdocuments/osp_discussion.Rnw', eval=T>>=
@
...
<<subdoc_content_acknowledgement, child='subdocuments/osp_acknowledgements.Rnw', eval=T>>=
@
