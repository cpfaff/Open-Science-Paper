...
\documentclass[nocolor, nocsvdata]{subdocuments/open_science_paper} 
...
%   the data folder to insert title header information into the document. (not fully finished feature)
